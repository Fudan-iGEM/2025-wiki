    ...
    items: [
      {
        icon: "contribution",
        title: "Contribution",
        description: "For future iGEM teams",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        icon: "model",
        title: "Model",
        description: "Mathematical modeling and simulations",
        link: "/fudan/model/",
      },
      {
        icon: "software",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        icon: "wiki",
        title: "Wiki",
        description: "Source code hosted on GitLab",
