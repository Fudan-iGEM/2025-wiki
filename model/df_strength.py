...
def model_parameters(promoter_strength_factor=1.0):
    """
    Set model parameters based on the promoter strength.
    promoter_strength_factor adjusts the strength (default = 1.0 for normal, 
    <1 for weak, >1 for strong).
    """
...
def simulate_timer(pulse_amplitude, maturation_rate, noise_level, total_protein, generations=10):
    """
    Simulate the evolution of the fluorescent timer over several generations.
    """
...
def calculate_SNR(B, R, noise_level):
    """
    Calculate the Signal-to-Noise Ratio (SNR) based on the proteins' concentrations.
    """
