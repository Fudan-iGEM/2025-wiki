...
### **Rethinking Technology and Responsibility**

Through months of dialogue—with scientists, clinicians, policymakers, and designers—we sought to weave inclusivity, reflection, and real-world responsiveness into every part of our work.

What follows is the story of how each encounter reshaped our understanding of what it means to build technology that serves humanity.
...
>**Key Takeaways：**
>
>- Professor Lu proposed that with the rapid rise of large-scale AI models, one promising direction for biology is to simulate living systems through artificial digital frameworks — what he termed an “AI Yeast System.” This concept aligns closely with our project’s vision of simulation-driven biological design and opens new possibilities for computationally guided research in biopharmaceuticals.
>
>- His insights deeply influenced our thinking and helped shape the foundation of our modeling strategy, which aims to predict and guide experimental outcomes (see our [Model Page](https://2025.igem.wiki/fudan/model.html)).
>
>- Through continued discussion, we refined our concept and decided to develop a *multicellular yeast* platform for dynamic screening of antibiotic-resistance targets — forming the initial blueprint of the project we are building today.
