...
| ------------- | ---------------- | ------------ | ------------------------------------------------------------ |
| original part | mCherry          | BBa_J06504   | monomeric RFP optimized for bacteria                         |
...
<div style="text-align: center;" id="fig2">    <img src="https://static.igem.wiki/teams/5643/pageimage/improved-part/modified-mcherry.webp" style="width:80%">    <div>        <span style="color:gray">Figure 2: Structure of modified mCherry.The mutated residues and the fluorescent core are highlighted in different colors.Structural data were obtained from the Protein Data Bank (ID: pdb_00003lf3).</span>        <br><br>    </div></div>

Based on the study by Subach et al. (2009)[^1], the red/blue fluorescence intensity ratio of modified mCherry increases progressively over time (Figure 2d–f). Furthermore, the rate of increase is positively correlated with temperature. According to these findings, we calculated the red/blue ratio at 30°C to represent the maturation stage of the fluorescent protein, thereby serving as a quantitative indicator of elapsed time.
...
This year, we are honored to introduce an advanced Fluorescent Timer (FT) element—a component validated by the academic community—into the iGEM registry. The core coding sequence of this part originates from a previously published work of rational protein engineering. For the first time, we have incorporated this efficient element into the Registry as a fully documented part with a standard BioBrick interface .
...
By introducing a high-performance, user-friendly modified mCherry  to the iGEM community, we provide a practical tool for long-term temporal recording. Meanwhile, our understanding of disruptive innovations such as tr-FTs underscores our strategic awareness of the emerging trend toward temporal functional expansion in fluorescent tools.
